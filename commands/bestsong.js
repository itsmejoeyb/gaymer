...
module.exports = {
    ...
    async execute(message, args) {
        ...
        let song = {
            title: 'The Rythm of the Night',
            url: 'https://www.youtube.com/watch?v=Kypja9eDo88',
            description: 'The rhythm of my life. 🍕',
            thumbnailUrl: 'https://i.ytimg.com/vi/Kypja9eDo88/mqdefault.jpg',
            user: message.author,
            command: true,
            commandTitle: '!bestsong',
        }
